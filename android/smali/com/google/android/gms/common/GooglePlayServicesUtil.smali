...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, p1, p0, v8, v4}, Lcom/google/android/gms/common/GoogleApiAvailability;->zza(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-direct {v4, p1}, Landroid/support/v4/app/bj;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/bj;->a(I)Landroid/support/v4/app/bj;

    move-result-object v4

    .line 2128
    iget-object v5, v4, Landroid/support/v4/app/bj;->B:Landroid/app/Notification;

    invoke-static {v1}, Landroid/support/v4/app/bj;->c(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 2950
    iget-object v1, v4, Landroid/support/v4/app/bj;->B:Landroid/app/Notification;
    ...
    .line 4083
    iput-object v3, v4, Landroid/support/v4/app/bj;->d:Landroid/app/PendingIntent;

    .line 0
    invoke-virtual {v4, v0}, Landroid/support/v4/app/bj;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/bj;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v4/app/bj;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/bj;
...
.method public static zza(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->c()Landroid/support/v4/app/y;
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/app/y;Ljava/lang/String;)V
