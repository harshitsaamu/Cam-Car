...
# static fields
.field static final g:Landroid/support/v4/widget/u;
...
.field final a:Landroid/support/v4/widget/cb;

.field final b:Landroid/support/v4/widget/cb;
...
.field private final k:Landroid/support/v4/widget/t;
...
.field private x:Landroid/support/v4/widget/x;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/u;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/t;
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/v4/widget/z;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/z;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/z;

    .line 360
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/z;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/cb;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ce;)Landroid/support/v4/widget/cb;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;

    .line 361
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;

    .line 2437
    iput v4, v2, Landroid/support/v4/widget/cb;->j:I

    .line 362
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;

    .line 3401
    iput v1, v2, Landroid/support/v4/widget/cb;->h:F

    .line 363
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/z;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;

    .line 3816
    iput-object v3, v2, Landroid/support/v4/widget/z;->b:Landroid/support/v4/widget/cb;

    .line 365
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/z;

    invoke-static {p0, v5, v2}, Landroid/support/v4/widget/cb;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ce;)Landroid/support/v4/widget/cb;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;

    .line 366
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;

    .line 4437
    const/4 v3, 0x2

    iput v3, v2, Landroid/support/v4/widget/cb;->j:I
    ...
    .line 368
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/z;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;

    .line 5816
    iput-object v2, v1, Landroid/support/v4/widget/z;->b:Landroid/support/v4/widget/cb;
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/bt;->a(Landroid/view/View;Landroid/support/v4/view/a;)V

    .line 377
    invoke-static {p0}, Landroid/support/v4/view/cr;->a(Landroid/view/ViewGroup;)V

    .line 378
    invoke-static {p0}, Landroid/support/v4/view/bt;->q(Landroid/view/View;)Z
    ...
    .line 379
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/u;
...
.method private a(II)V
    ...
    .line 545
    invoke-static {p0}, Landroid/support/v4/view/bt;->e(Landroid/view/View;)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;

    .line 555
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/cb;->a()V
    ...
    .line 554
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;
...
.method private a(Z)V
    ...
    .line 1410
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/cb;->a(Landroid/view/View;II)Z
    ...
    .line 1413
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/cb;->a(Landroid/view/View;II)Z
    ...
    .line 1420
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/z;

    invoke-virtual {v0}, Landroid/support/v4/widget/z;->a()V

    .line 1421
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v4/widget/z;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    .line 1024
    :cond_1
    invoke-static {p0, p1}, Landroid/support/v4/a/a/a;->b(Landroid/graphics/drawable/Drawable;I)V
...
.method private h(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/cb;->a(Landroid/view/View;II)Z
...
.method final a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/bt;->c(Landroid/view/View;I)V
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/bt;->c(Landroid/view/View;I)V
    ...
    .line 1748
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/t;

    invoke-static {p1, v0}, Landroid/support/v4/view/bt;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/cb;->c()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;

    invoke-virtual {v1}, Landroid/support/v4/widget/cb;->c()Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 6448
    iget v2, v2, Landroid/support/v4/widget/cb;->i:I
    ...
    .line 1255
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;

    .line 7448
    iget v3, v3, Landroid/support/v4/widget/cb;->i:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1194
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/u;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Landroid/support/v4/widget/cb;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->b:Landroid/support/v4/widget/cb;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/cb;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1294
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;

    float-to-int v0, v0

    float-to-int v3, v3

    invoke-virtual {v5, v0, v3}, Landroid/support/v4/widget/cb;->b(II)Landroid/view/View;
    ...
    .line 8309
    iget-object v0, v5, Landroid/support/v4/widget/cb;->c:[F
    ...
    .line 8867
    iget v3, v5, Landroid/support/v4/widget/cb;->g:I
    ...
    .line 8341
    iget-object v3, v5, Landroid/support/v4/widget/cb;->e:[F

    aget v3, v3, v0

    iget-object v7, v5, Landroid/support/v4/widget/cb;->c:[F
    ...
    .line 8342
    iget-object v7, v5, Landroid/support/v4/widget/cb;->f:[F

    aget v7, v7, v0

    iget-object v8, v5, Landroid/support/v4/widget/cb;->d:[F
    ...
    iget v7, v5, Landroid/support/v4/widget/cb;->b:I

    iget v8, v5, Landroid/support/v4/widget/cb;->b:I
...
.method protected onMeasure(II)V
    ...
    .line 927
    invoke-static {v7}, Landroid/support/v4/view/bt;->q(Landroid/view/View;)Z
    ...
    .line 928
    sget-object v9, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/u;

    iget-object v10, p0, Landroid/support/v4/widget/DrawerLayout;->D:Ljava/lang/Object;

    invoke-interface {v9, v7, v10, v8}, Landroid/support/v4/widget/u;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-interface {v9, v0, v10, v8}, Landroid/support/v4/widget/u;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    .line 943
    invoke-static {v7}, Landroid/support/v4/view/bt;->n(Landroid/view/View;)F
    ...
    invoke-static {v7, v8}, Landroid/support/v4/view/bt;->e(Landroid/view/View;F)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/cb;->b(Landroid/view/MotionEvent;)V
    ...
    .line 1347
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/cb;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/cb;->b(II)Landroid/view/View;
    ...
    .line 10490
    iget v4, v4, Landroid/support/v4/widget/cb;->b:I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/bt;->e(Landroid/view/View;F)V
...
.method public setDrawerListener(Landroid/support/v4/widget/x;)V
    ...
    .prologue
    .line 504
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Landroid/support/v4/widget/x;
