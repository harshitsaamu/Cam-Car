...
.method public final a(Landroid/support/v4/app/bj;Landroid/support/v4/app/bk;)Landroid/app/Notification;
    ...
    .prologue
    .line 571
    iget-object v0, p1, Landroid/support/v4/app/bj;->a:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/bj;->B:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/bj;->h:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/bj;->f:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/bj;->i:I

    iget-object v7, p1, Landroid/support/v4/app/bj;->d:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/bj;->e:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/bj;->g:Landroid/graphics/Bitmap;
