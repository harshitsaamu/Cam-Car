...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/cg;->c:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/cg;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/cg;->b:Landroid/os/Bundle;

    .line 103
    if-eqz p18, :cond_0

    .line 104
    iget-object v4, p0, Landroid/support/v4/app/cg;->b:Landroid/os/Bundle;
...
.method public final a()Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 129
    iget-object v0, p0, Landroid/support/v4/app/cg;->a:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method public final a(Landroid/support/v4/app/cb;)V
    .locals 2

    .prologue
    .line 124
    iget-object v0, p0, Landroid/support/v4/app/cg;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/cg;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/cf;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/cb;)Landroid/os/Bundle;
...
.method public final b()Landroid/app/Notification;
    ...
    .line 136
    invoke-static {v1}, Landroid/support/v4/app/cf;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v4/app/cg;->b:Landroid/os/Bundle;
    ...
    invoke-static {v0}, Landroid/support/v4/app/cf;->a(Ljava/util/List;)Landroid/util/SparseArray;
